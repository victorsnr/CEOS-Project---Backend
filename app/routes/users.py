...
def cadastrar_usuario():
    ...
    if not nome or not username or not email or not cpf or not dt_nasc or not password:
    ...
    try:
        ...
        db.session.rollback()
        return jsonify({'message': 'Erro! Possível duplicação de dados! Verifique seu email e CPF'}), 400
